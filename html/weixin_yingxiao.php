						...
						<ul>
							<li style="display:block;">
								...
								<div class="WMain3 WMain3_2"><p><i class="LGntas"></i>开始时间:</p>
									<input type="text" name="textfield" id="datepicker1" class="txt2 txt2_2"/><br/>
							...
							<div class="left_div">
								<div class="WMain3 WMain3_2"><p><i class="LGntas"></i>原文链接:</p>
									<input type="text" name="textfield" id="textfield" class="txt6"/><br/>
								...
								<div class="WMain3"><p><i class="LGntas"></i></p>
									 <label><input type="checkbox" name="admit" id="admit" />同意相关 <a href="">服务协议</a></label>
								</div>
							</div>
							</li>
						</ul>
