    ...
    <div style="width: 633px;HEIGHT: 580px;background:#fff;border-radius:10px;">
        ...
        <div class="LGn1">
            ...
            <div class="LGnt1"><p>验证码:</p>
                <input type="text" name="textfield" id="textfield"  class="LGnt3"/>
                <div class="LGnt4">验码图形</div>
                <i><span>看不清楚，</span>换一张？</i>
            </div>
            <div style="float:left; margin-left:45px;">
                <input type="submit" name="button" id="button" value="提 交" class="LGButton1"/>
                <input type="submit" name="button" id="button" value="注 册" class="LGButton2"/>
            </div>
            <div class="LOGOds">
                <div class=dsRight>&nbsp;</DIV><h3>第三方登录</h3><div class=dsRight>&nbsp;</DIV>
                <ul class="LGnt5">
                    <li><img src="img/1at.jpg" /><p>微信</p></li>
