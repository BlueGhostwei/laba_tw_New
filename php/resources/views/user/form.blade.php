                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="name"
                                                               ...
                                                               class="form-control" placeholder="请输入用户名" user_id="{{isset($user->id)?$user->id:''}}" />
                                                        {{--@if (isset($user))@else
                                                            @if ($errors->has('name'))
                                                                <label class="error">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <div class="imgPreViewBox col-lg-cover">
                                                            ...
                                                            @else
                                                                <div class="imgPreView-item">
                                                                    <div class="glyphicon glyphicon-remove imgPreViewi-close"></div>
                                                                    <img src="{{url('/images/touxiang_gg.jpg')}}" class="imgPreViewi-img">
