...
<div id=RELogin style="">
    <div style=" width:250px; margin:auto;"><a href="{{route('admin.dashboard')}}"><img src="../img/logolaba.png"
    ...
    <div style="width: 850px;HEIGHT: 530px;background:#fff;border-radius:10px;">
        ...
        <div class="LGn2">
            <h4>已经注册过？<a href="{{route('user.login')}}"><input type="submit" name="button" id="button" value="登 录"
                                                               class="LGBo1"/></a></h4>
