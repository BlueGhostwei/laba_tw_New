            ...
            <option value="5">5</option>
                            ...
                            <div class="sbox_3_table">
                                <table class="" width="100%">
                                    ...
                                    <tbody>
                                    <tr>
                                        <td class="sbox_3_t1"><img src="{{url('Admin/images/pic5.jpg')}}"/> 贾乃亮</td>
                        ...
                        <div class="sbox_5">
                            <div class="WIn2">
                                        ...
                                        <ul>
                                            <li style="display:block;">
                                                ...
                                                <div class="WMain3 WMain3_2"><p><i class="LGntas"></i>直播内容:</p>
                                                    <div><textarea name="" class="tarea_1"
                                                                   style="width:75%;"></textarea></div>
                                                </div>
                                                ...
                                                <div class="WMain3 WMain3_2"><p><i class="LGntas"></i>预约结果反馈时间:</p>
                                                    <input type="text" name="textfield" id="datepicker3"
                                                           class="txt2 txt2_2"/>
                                                </div>
                                                ...
                                                <div class="WMain3 WMain3_2"><p><i class="LGntas"></i>是否短信通知:</p>
                                                    ...
                                                    <div><label><input type="checkbox" name="admit" id="admit"/>同意相关 <a
                                                                    href="">服务协议</a></label></div>
                                                    <br/>
                                                </div>
                                            </li>
                                        </ul>
                                ...
                                <div class="clr btn_sub_w">
                                    <button type="submit" value="submit" class="btn_sub"><img src="{{url('Admin/img/WLButton.png')}}"/>
                                    </button>
                                </div>
                                <script>
                                    $(function () {
