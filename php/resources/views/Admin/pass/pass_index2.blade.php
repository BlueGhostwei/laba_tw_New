...
<div id=RELogin style="">
    ...
    <div style="width: 850px;HEIGHT: 600px;background:#fff;border-radius:10px;">
        ...
        <div class="web-width">
            ...
            <form action="{{route('Admin.pass_find_send')}}" method="post">
                {{ csrf_field() }}
            ...
            <div class="forget-pwd">
              ...
              {{--  <div class="LGnt6"><p>用户名:</p>
                ...
                <div class="LGnt6 sel-yzsj"><p>验证手机:</p>
                    <input type="text" name="user_tel" id="user_tel"  class="Bpass_name"/>
                </div>
                <div class="LGnt6 sel-yzyx"><p>验证邮箱:</p>
                    <input type="text" name="user_email" id="user_email"  class="Bpass_name"/>
                </div>
