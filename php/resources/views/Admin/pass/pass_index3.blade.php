...
<div id=RELogin style="">
    <div style=" width:250px; margin:auto;"><a href="{{route('admin.dashboard')}}"><img
                    src="{{url('Admin/img/logolaba.png')}}" style=" width:250px; height:auto"></a></div>
        ...
        <div class="web-width">
            <div class="for-liucheng">
                ...
                <div class="liutextbox">
                    ...
                    <div class="liutext"><em><img src="{{url('Admin/img/Bpass1.png')}}"/></em><br/><strong>完成</strong>
                    </div>
                </div>
            </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.sta == '0') {
                        ...
                        window.location.href = "{{route('Admin.pass_info')}}"
                    } else {
